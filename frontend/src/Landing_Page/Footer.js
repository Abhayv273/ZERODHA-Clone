    ...
    <footer style={{ backgroundColor: "rgb(250, 250, 250)" }}>
      <div className="container border-top mt-5">
        <div className="row mt-5">
          <div className="col">
            <img src="media/images/logo.svg" style={{ width: "50%" }} alt='footerlogo' />
            <p>
              &copy; 2010 - 2026, Not Zerodha Broking Ltd. All rights reserved.
              <br></br>
              <div style={{fontSize:"30px",cursor:"pointer"}}><a href="/"><i class="fa-brands fa-linkedin"></i></a>
              <a href="/"><i class="fa-brands fa-github"></i></a>
              <a href="/"><i class="fa-brands fa-telegram"></i></a>
              <a href="/"><i class="fa-brands fa-facebook"></i></a></div>
            </p>
            <hr></hr>
            <div style={{width:"150px",maxWidth: "100%",height: "auto" ,display:"flex",gap:"8px"}}>
              <img
